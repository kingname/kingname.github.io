;(function (window) {
  ...
  let texts = ['蔚蓝星空下', '我看着你', '想要做一千件事', '让你开心起来', '却总是放下', '已经攥紧的拳头', '空荡荡', '因为我知道', '你心中有个人', '那是你筑起的城堡', '我走不近', '只能呆呆望着', '其实我也知道', '这样很傻', '但是放下', '却做不到', '在城堡外', '继续等待', '嘿', '女孩', '我能成为', '你的星星吗',  '给你依赖', '给你幸福', '等待着你', 'Always']
